...
public class enemy_monster_03 : enemy
{
    ...
    new void Start()
    {
        ...
        monster_skullTransform = GameObject.FindGameObjectWithTag("skull").GetComponent<Transform>();
        monster_skullsr = GameObject.FindGameObjectWithTag("skull").GetComponent<SpriteRenderer>();
        monster_skull_coll = GameObject.FindGameObjectWithTag("skull").GetComponent<Collider2D>();
        monster_skull_rb = GameObject.FindGameObjectWithTag("skull").GetComponent<Rigidbody2D>();
